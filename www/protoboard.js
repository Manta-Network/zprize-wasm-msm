...
class Protoboard {
    ...
    constructor() {
        this.defBytes = 48;
        this.bitsPerBytes = 32;

        this.memory = new WebAssembly.Memory({initial:20000});
        this.i32 = new Uint32Array(this.memory.buffer);
        this.i8 = new Uint8Array(this.memory.buffer);
