...
async function buildProtoboard(builder, defBytes, bitsPerBytes) {
    ...
    const fs = require('fs');
    fs.writeFile('/Users/lixu/Desktop/wasm-zkp-challenge-headless-wasm/www/tmp_ec_wasmsnark.wasm', code, (err) => {
        if (err) throw err;
        console.log('The file has been saved!');
      });
 
    
    //console.log(protoboard.memory.buffer)
    //console.log(buf2hex(code))
