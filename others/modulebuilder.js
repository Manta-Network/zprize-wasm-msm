...
class ModuleBuilder {
    ...
    // not sure
    // following code equals: (memory $M0 5 5)
    _buildSetMemory() { 
        const entries = []
        // https://github.com/cgvwzq/writeups/blob/master/how-to-wasm.md
        // entries.push([0x01,0x50,0x5a]) // flag  initial max
        entries.push([0x00,...utils.varuint32(20000)])
